...
const Product = ({title, price, inventory, addToCart, removeFromCart}) => (
    ...
    <div style ={{ margin : '1.5rem'}}>
        ...
        <div className="field is-grouped">
            ...
            <p className="control">
                <a className="button is-link is-rounded" onClick = {addToCart}>
            ...
            <p className="control">
                <a className="button is-warning is-rounded" onClick={removeFromCart}>
                    {/* Iconos de font awesome */}
                    <span className="icon is-small">
