...
public class PlayerMovement : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 deathKick = new Vector2(0f,15f);
    ...
    private bool isTouchingEnemys = false;
    ...
    private void Die()
    {
        if (this.isTouchingEnemys || this.isTouchingHazards)
        {
    ...
    private void IsTouchingSomething(){
        ...
        this.isGrounded = this.myFeetCollider2D.IsTouchingLayers(LayerMask.GetMask("Ground"));
        //Si esta tocando las escaleras
        this.isTouchingLadder = this.myFeetCollider2D.IsTouchingLayers(LayerMask.GetMask("Ladder"));
        //Si esta tocando enemigos
        this.isTouchingEnemys = this.myBodyCollider2D.IsTouchingLayers(LayerMask.GetMask("Enemy"));
        //Si esta tocando los picos
        this.isTouchingHazards = this.myBodyCollider2D.IsTouchingLayers(LayerMask.GetMask("Hazards"));
        this.isTouchingHazards = this.myFeetCollider2D.IsTouchingLayers(LayerMask.GetMask("Hazards"));
